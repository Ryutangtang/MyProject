...
template<> HOUDINIENGINE_API UScriptStruct* StaticStruct<FHoudiniAttributeResolver>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniStringResolver_h_Statics::ScriptStructInfo[] = {
		{ FHoudiniStringResolver::StaticStruct, Z_Construct_UScriptStruct_FHoudiniStringResolver_Statics::NewStructOps, TEXT("HoudiniStringResolver"), &Z_Registration_Info_UScriptStruct_HoudiniStringResolver, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniStringResolver), 587215485U) },
		{ FHoudiniAttributeResolver::StaticStruct, Z_Construct_UScriptStruct_FHoudiniAttributeResolver_Statics::NewStructOps, TEXT("HoudiniAttributeResolver"), &Z_Registration_Info_UScriptStruct_HoudiniAttributeResolver, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniAttributeResolver), 1496496612U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniStringResolver_h_2311886476(TEXT("/Script/HoudiniEngine"),
		nullptr, 0,
