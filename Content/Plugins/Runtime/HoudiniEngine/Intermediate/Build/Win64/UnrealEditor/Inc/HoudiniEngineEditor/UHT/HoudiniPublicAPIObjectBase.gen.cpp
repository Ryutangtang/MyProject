...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_SetErrorMessage_Statics::NewProp_InErrorMessage = { "InErrorMessage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(HoudiniPublicAPIObjectBase_eventSetErrorMessage_Parms, InErrorMessage), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_SetErrorMessage_Statics::NewProp_InErrorMessage_MetaData), Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_SetErrorMessage_Statics::NewProp_InErrorMessage_MetaData) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_ClearErrorMessages, "ClearErrorMessages" }, // 2635621910
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_GetLastErrorMessage, "GetLastErrorMessage" }, // 3469961921
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_IsLoggingErrors, "IsLoggingErrors" }, // 2739738253
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_SetErrorMessage, "SetErrorMessage" }, // 942952898
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_SetLoggingErrorsEnabled, "SetLoggingErrorsEnabled" }, // 1491204623
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_LastErrorMessage = { "LastErrorMessage", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniPublicAPIObjectBase, LastErrorMessage), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_LastErrorMessage_MetaData), Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_LastErrorMessage_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bHasError = { "bHasError", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UHoudiniPublicAPIObjectBase), &Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bHasError_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bHasError_MetaData), Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bHasError_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bIsLoggingErrors = { "bIsLoggingErrors", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UHoudiniPublicAPIObjectBase), &Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bIsLoggingErrors_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bIsLoggingErrors_MetaData), Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bIsLoggingErrors_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h_Statics::EnumInfo[] = {
		{ EHoudiniPublicAPIErrorLogOption_StaticEnum, TEXT("EHoudiniPublicAPIErrorLogOption"), &Z_Registration_Info_UEnum_EHoudiniPublicAPIErrorLogOption, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4262879404U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniPublicAPIObjectBase, UHoudiniPublicAPIObjectBase::StaticClass, TEXT("UHoudiniPublicAPIObjectBase"), &Z_Registration_Info_UClass_UHoudiniPublicAPIObjectBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniPublicAPIObjectBase), 1146613263U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h_3370015574(TEXT("/Script/HoudiniEngineEditor"),
